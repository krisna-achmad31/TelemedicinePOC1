...
//            }
    ...
    private fun setCancelDialog() {
        val title = "Konfirmasi Pembatalan Jadwal"
        val description= "Apakah Anda yakin untuk pembatalan jadwal konsultasi ini?"
...
//                    }
//                }
                Toast.makeText(context,"Berhasil melakukan pembatalan jadwal konsultasi",Toast.LENGTH_SHORT).show()
            }
            onCancelClicked = {
                dismiss()
            }
